...
dojo.declare(
	...
	null,
	{
		...
		createGui:function () {
            ...
            { name: "Arabic" ,id: "ar"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.bul") ,id: "bg"},
            { name: "Catalan" ,id: "ca"},
            { name: "Czech" ,id: "cs"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.dan") ,id: "da"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.ger")  ,id: "de"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.gre") ,id: "el"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.eng") ,id: "en"},
            { name: "English (US)" ,id: "en-US"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.spa") ,id: "es"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.est") ,id: "et"},
            { name: "Basque" ,id: "eu"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.fin") ,id: "fi"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.fre") ,id: "fr"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.gle") ,id: "ga"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.hun") ,id: "hu"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.ita"),id: "it"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.lit") ,id: "lt"},
            { name: "Latvian" ,id: "lv"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.mlt") ,id: "mt"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.dut") ,id: "nl"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.nor") ,id: "no"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.pol") ,id: "pl"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.por") ,id: "pt"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.rum") ,id: "ro"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.rus") ,id: "ru"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.slo") ,id: "sk"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.slv") ,id: "sl"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.swe") ,id: "sv"},
            { name: gxeContext.getI18NString("mdCode.language.iso639_2.chi") ,id: "zh-CN"}
              ];
	        ...
	        var etichetta= gxeContext.getI18NString("gemet.find");
