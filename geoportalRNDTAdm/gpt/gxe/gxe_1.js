...
dojo.declare("gxe.xml.DomProcessor",null,{
  ...
  matchTopElement: function(xmlNamespaces,domNode,sMatchPath,sMatchTextNodeValue,bMust,bRegx) {
          ...
          dojo.hitch(this,function(domChildNode) {
            if (bIsLast) {
              if (sMatchTextNodeValue == null) {
				...
				//Modifica pe rimplementazione stringa RegExp 01/02/2017
				if (bRegx){
...
//        var sXml = gxe.xml.Generator().getXMLValueByPath(objReturn.valoreRit,xmlGenerator2);
//        //var sXml2 = gxe.xml.Generator().getXMLValueByPath(arrayOne[1],xmlGenerator);
//        if (((sXml==null) || (sXml=="")) ) {
//            var status = {"isValid": true, "message": "?ok"};
//            status.isValid = false;
//            //status.message = "?invalid "+sLabel+" "+pattern;
//            status.message = this.formatValidationMessage(objReturn.objInput,"validate.other");
...
getXMLValueByPath: function(nodepath, xml)
{
    ...
    var result="";
    //var result = doc.evaluate(nodepath, doc, resolver, XPathResult.STRING_TYPE, null).stringValue;
    var iterator = doc.evaluate(nodepath, doc, resolver, XPathResult.UNORDERED_NODE_ITERATOR_TYPE, null );
...
getFormElement: function (pathToFind,context){
   ...
   */
  handleValidationErrorMultiple:function(sMessage,xmlNode,inputControlArr) {
    var bHadErrors = false;
    if (!this.isSaveAsDraft) {
      this.hadValidationErrors = true;
      this.context.messageArea.addValidationErrorMultiple(sMessage,xmlNode,inputControlArr);
    } else {
          ...
          for (var i=0; i<domMatches.length; i++) {
            ...
            gxe.cfg.forEachChild(cfgMatchTop,gxe.cfg.uriGxe,"match",
              dojo.hitch(this,function(cfgChild) {
                ...
                if (qPath != null) {
                  var b = domProcessor.matchTopElement(ns,nd,qPath,qValue,bMust,bRegx);
...
dojo.declare("gxe.control.MessageArea",gxe.control.Control,{
   ...
   */
  addValidationErrorMultiple: function(sMessage,xmlNode,inputControlArr) {
    ...
    if (inputControlArr[1] == null) {
      ...
      if (inputControlArr[1].htmlElement != null) {
        var sTip = inputControlArr[1].htmlElement.title;
        if ((typeof(sTip) != "undefined") && (sTip != null)) {
          sTip = dojo.trim(sTip);
...
dojo.declare("gxe.control.Section",gxe.control.Control,{
  ...
  initialize: function(context,cfgObject) {
    ...
    if (!this.showArrow) useExclusiveDisplay=true;
    this.inherited(arguments);
  },
...
dojo.declare("gxe.control.Map",gxe.control.Control,{
  ...
  build: function(htmlParentElement,domProcessor,domNode) {
    ...
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Valle d'Aosta/Valle d'Aoste","6.8;45.46;7.94;45.99",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Lombardia","8.49;44.67;11.43;46.64",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Trentino-Alto Adige","10.38;45.67;12.48;47.1",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Veneto","10.62;44.79;13.11;46.69",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Friuli-Venezia Giulia","12.32;45.58;13.92;46.65",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Liguria","7.49;43.77;10.08;44.68",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Emilia-Romagna","9.19;43.73;12.76;45.14",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Toscana","9.68;42.23;12.38;44.48",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Umbria","11.89;42.36;13.27;43.62",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Marche","12.18;42.68;13.92;43.97",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Lazio","11.44;40.78;14.03;42.84",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Abruzzo","13.01;41.68;14.79;42.9",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Molise","13.94;41.36;15.17;42.07",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Campania","13.76;39.99;15.81;41.51",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Puglia","14.93;39.79;18.53;42.23",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Basilicata","15.33;39.89;16.87;41.14",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Calabria","15.63;37.91;17.21;40.15",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Sicilia","11.92;35.49;15.66;38.82",false,false);
    elOptions[elOptions.length] = elOption;
    elOption = new Option("Sardegna","8.13;38.85;9.83;41.32",false,false);
    elOptions[elOptions.length] = elOption;
...
dojo.declare("gxe.control.InputBoxWithCheck",gxe.control.InputText,{
  supportsMultipleValues: false,
  /**
   * Utility to enable/disable the anchor that launches the GEMET dialog.
   * <br/>The anchor is enabled when text has been entered into the associated input text box.
  ...
  onHtmlChildrenCreated: function(domProcessor,domNode) {
   ...
   this.inherited(arguments);
    ...
    dojo.connect(elLink,"onclick",this,dojo.hitch(this,function(e) {
        if (this.htmlElement.value.startsWith(stringaInit)){
            if (s.length>0){
                var regexp = new RegExp(s);
                if (!regexp.test(this.htmlElement.value)) {
                    alert(this.context.getI18NString("validate.other"));
                }  else {
                    alert(this.context.getI18NString("validate.valid"));
                }
            } else {
                alert(this.context.getI18NString("validate.valid"));
            }
...
dojo.declare("gxe.control.InputBoxWithValueFrom",gxe.control.InputText,{
  ...
  onHtmlChildrenCreated: function(domProcessor,domNode) {
   ...
   this.inherited(arguments);
    ...
    elLink.setAttribute("href","javascript:void(0);");
    elLink.className = "gxeInputTool";
    elLink.appendChild(document.createTextNode(this.context.getI18NString("identifier.CopyFrom")));//this.context.getI18NString("identifier.verify")));
    this.htmlElement.parentNode.appendChild(elLink);
