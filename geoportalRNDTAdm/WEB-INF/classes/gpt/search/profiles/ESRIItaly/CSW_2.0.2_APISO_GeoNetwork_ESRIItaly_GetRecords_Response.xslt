				...
				<Records>
					...
					<xsl:for-each select="/csw:GetRecordsResponse/csw:SearchResults/gmd:MD_Metadata">
						<Record>
							...
							<Links>	
								<!-- Esri Italy: If the link is a download link then preview is not useful -->
								<xsl:if test="contains($valid-Url/gmd:protocol/gco:CharacterString,'DOWNLOAD') or contains($valid-Url/gmd:protocol/gco:CharacterString,'download')">
								...
								<xsl:for-each select="./gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine">
									...
									<xsl:if test="contains($online-resource/gmd:CI_OnlineResource/gmd:protocol/gco:CharacterString,'WMS') or contains($online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'WMS') or contains($online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'wms')">
										<Link label="catalog.rest.wms">
											<xsl:value-of select="$online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL"/> 
										</Link>
									</xsl:if>

									<xsl:if test="contains($online-resource/gmd:CI_OnlineResource/gmd:protocol/gco:CharacterString,'WFS') or contains($online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'WFS') or contains($online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'wfs')">
										<Link label="catalog.rest.wfs">
											<xsl:value-of select="$online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL"/> 
										</Link>
									</xsl:if>

									<xsl:if test="contains($online-resource/gmd:CI_OnlineResource/gmd:protocol/gco:CharacterString,'download') or contains($online-resource/gmd:CI_OnlineResource/gmd:linkage/gmd:URL,'download')">
