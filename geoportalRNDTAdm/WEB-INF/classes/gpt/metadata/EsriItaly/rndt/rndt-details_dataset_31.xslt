...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:srv="http://www.isotc211.org/2005/srv">
	...
	<xsl:template match="gmd:MD_DataIdentification | srv:SV_ServiceIdentification">
		<dl>
          ...
          <em>
			...
			<xsl:if test="gmd:supplementalInformation/gco:CharacterString">
				<dt>
					<em>
						<xsl:call-template name="get_property">
	...
	<!-- gmd:CI_Citation -->
	<xsl:template match="*[self::gmd:citation or self::gmi:citation]/gmd:CI_Citation">
		<em>
			<xsl:call-template name="get_property">
...
-->
	...
	<!-- Variabili -->
		...
		<xsl:variable name="urlSito" select="'https://geodati.gov.it/geoportalRNDTPA/catalog/search/resource/details.page?uuid='" /> 
		...
		<xsl:variable name="email" select="/gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:citedResponsibleParty/gmd:CI_ResponsibleParty/gmd:contactInfo/gmd:CI_Contact/gmd:address/gmd:CI_Address/gmd:electronicMailAddress/gco:CharacterString" />
		...
		<script type="application/ld+json">
		{
		 ...
		 "@type": "PropertyValue",
		  ...
		  "sameAs":"<xsl:value-of select="concat($urlSito, $fileId)" />",

		  "keywords":"<xsl:value-of select="translate($keywords,'&#xA;&#xD;&#x20;&#x9;', '')" />",

		  "spatial":[{"@type":"Place","geo":{"@type":"GeoShape","box":"<xsl:value-of select="concat($boxWest, ' ', $boxSouth, ' ', $boxEast, ' ', $boxNorth)" />"}}],
		  "distribution":[
