...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:srv="http://www.isotc211.org/2005/srv">
		...
		<dl>
			...
			<xsl:if test="/*[self::gmd:MD_Metadata or self::gmi:MI_Metadata]/gmd:referenceSystemInfo">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.iso19139.MD_Metadata.<xsl:value-of select="local-name(/*[self::gmd:MD_Metadata or self::gmi:MI_Metadata]/gmd:referenceSystemInfo)"/>
							</xsl:with-param>
						</xsl:call-template>
						<xsl:text>:&#x20;</xsl:text>
					</em>
				...
				<dt>
					...
					<xsl:for-each select="gmd:topicCategory/gmd:MD_TopicCategoryCode">
						<dt>
							<em>
								<xsl:call-template name="get_property">
									<xsl:with-param name="key">catalog.iso19139.MD_TopicCategoryCode.</xsl:with-param>
								</xsl:call-template>
								<xsl:text>:&#x20;</xsl:text>
							</em>
							<xsl:value-of select="."/>
	...
	<xsl:template name="get_property">
		...
		<xsl:choose>
			...
			<xsl:when test=' $key = &quot;catalog.iso19139.CI_ResponsibleParty.organisationName&quot; '>i18n.catalog.mdParam.rndt.general.contact.organization</xsl:when>
