...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:xlink="http://www.w3.org/1999/xlink">
		...
		<dl>
			...
			<xsl:for-each select="gmd:characterSet">
				<dt>
					...
					<xsl:choose>
						<xsl:when test=" string-length(/*[self::gmd:MD_Metadata or self::gmi:MI_Metadata]/gmd:characterSet) > 0">
							<xsl:call-template name="get_property">
			...
			<xsl:if test="gmd:citation/gmd:CI_Citation/gmd:presentationForm">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.citation.presentationForm</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
			...
			<xsl:if test="gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:RS_Identifier | gmi:identifier/gmd:MD_Identifier">
				<dt>
					<xsl:apply-templates select="gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:RS_Identifier | gmi:identifier/gmd:MD_Identifier"/>
				</dt>
			</xsl:if>
			...
			<xsl:if test="srv:serviceType/gco:LocalName">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.identification.service.serviceType</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
					<xsl:call-template name="get_property">
			...
			<xsl:for-each select="srv:couplingType/srv:SV_CouplingType">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.identification.serviceType.caption.metadataXML</xsl:with-param>
						</xsl:call-template>
						<xsl:text>:&#x20;</xsl:text>
					</em>
					<xsl:call-template name="get_property">
			...
			<xsl:for-each select="./srv:operatesOn">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.identification.coupledresource.operateson.operatesOn</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
			...
			<xsl:for-each select="gmd:resourceConstraints/gmd:MD_Constraints">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.constraints.service.caption</xsl:with-param>
						</xsl:call-template>
						<xsl:text>:&#x20;</xsl:text>
					</em>
		...
		<dl>
			<xsl:for-each select="gmd:keyword/gco:CharacterString">
				<dt>
					...
					<xsl:choose>
						<xsl:when test="(. ='humanInteractionService') or (. ='humanCatalogueViewer') or (. ='humanGeographicViewer') or (. ='humanGeographicSpreadsheetViewer') or (. ='humanServiceEditor') or (. ='humanChainDefinitionEditor')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='humanWorkflowEnactmentManager') or (. ='humanGeographicFeatureEditor') or (. ='humanGeographicSymbolEditor') or (. ='humanFeatureGeneralizationEditor') or (. ='humanGeographicDataStructureViewer') or (. ='infoManagementService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='infoFeatureAccessService') or (. ='infoMapAccessService') or (. ='infoCoverageAccessService') or (. ='infoSensorDescriptionService') or (. ='infoProductAccessService') or (. ='infoFeatureTypeService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='taskManagementService') or (. ='infoStandingOrderService') or (. ='infoOrderHandlingService') or (. ='infoGazetteerService') or (. ='infoRegistryService') or (. ='infoCatalogueService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='spatialCoordinateTransformationService') or (. ='spatialCoordinateConversionService') or (. ='spatialProcessingService') or (. ='subscriptionService') or (. ='workflowEnactmentService') or (. ='chainDefinitionService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='spatialFeatureMatchingService') or (. ='spatialFeatureManipulationService') or (. ='spatialDimensionMeasurementService') or (. ='spatialTilingChangeService') or (. ='spatialSamplingService') or (. ='spatialSubsettingService') or (. ='spatialImageGeometryModelConversionService') or (. ='spatialSensorGeometryModelAdjustmentService') or (. ='spatialOrthorectificationService') or (. ='spatialRectificationService') or (. ='spatialImageCoordinateConversionService') or (. ='spatialCoverageVectorConversionService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='thematicGeographicInformationExtractionService') or (. ='thematicChangeDetectionService') or (. ='thematicSpatialCountingService') or (. ='thematicSubsettingService') or (. ='thematicFeatureGeneralizationService') or (. ='thematicClassificationService') or (. ='thematicGoparameterCalculationService') or (. ='thematicProcessingService') or (. ='spatialProximityAnalysisService') or (. ='spatialPositioningService') or (. ='spatialRouteDeterminationService') or (. ='spatialFeatureGeneralizationService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:when test="(. ='temporalSubsettingService') or (. ='temporalReferenceSystemTransformationService') or (. ='temporalProcessingService') or (. ='thematicGeocodingService') or (. ='thematicGeoparsingService') or (. ='thematicObjectDetectionService') or (. ='thematicMultibandImageManipulationService') or (. ='thematicImageSynthesisService') or (. ='thematicImageUnderstandingService') or (. ='thematicImageManipulationService') or (. ='thematicReducedResolutionGenerationService') or (. ='thematicImageProcessingService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:when>				
						<xsl:when test="(. ='comRemoteFileAndExecutableManagement') or (. ='comMessagingService') or (. ='comGeographicFormatConversionService') or (. ='comGeographicCompressionService') or (. ='comTransferService') or (. ='comEncodingService') or (. ='comService') or (. ='metadataGeographicAnnotationService') or (. ='metadataStatisticalCalculationService') or (. ='metadataProcessingService') or (. ='temporalProximityAnalysisService') or (. ='temporalSamplingService')">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.identification.servicetype.<xsl:value-of select="."/>
								</xsl:with-param>
							</xsl:call-template>
		...
		<dl>
			<xsl:for-each select="gmd:accessConstraints">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.constraints.access</xsl:with-param>
						</xsl:call-template>
						<xsl:text>:&#x20;</xsl:text>
					</em>
					<xsl:call-template name="get_property">
	...
	<xsl:template name="Data_Quality_Info">
		...
		<dl>
			...
			<xsl:for-each select="/*[self::gmd:MD_Metadata or self::gmi:MI_Metadata]/gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_ConceptualConsistency/gmd:result">
				<xsl:if test="gmd:DQ_ConceptualConsistency">
					<dt>
						<em>
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdParam.rndt.dataQuality.conceptualConsistency.caption</xsl:with-param>
							</xsl:call-template>
							<xsl:text>:&#x20;</xsl:text>
						</em>
					</dt>
		...
		<dl>
			<xsl:if test="gmd:nameOfMeasure">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.dataQuality.conceptualConsistency.nameOfMeasure</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
					<xsl:value-of select="gmd:nameOfMeasure/gco:CharacterString | gmd:nameOfMeasure/gmx:Anchor"/> 
				</dt>
			</xsl:if>
			<xsl:if test="gmd:measureDescription">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.dataQuality.conceptualConsistency.measureDescription</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
					<xsl:value-of select="gmd:nameOfMeasure/gco:CharacterString | gmd:nameOfMeasure/gmx:Anchor"/> 
			...
			<xsl:if test="gmd:result">
				<dt>
					<em>
						<xsl:call-template name="get_property">
							<xsl:with-param name="key">catalog.mdParam.rndt.dataQuality.conceptualConsistency.value</xsl:with-param>
						</xsl:call-template>
						<xsl:text>&#x20;</xsl:text>
					</em>
	...
	<xsl:template match="srv:containsOperations/srv:SV_OperationMetadata">
		<dl>
			...
			<xsl:for-each select="srv:DCP">
				<xsl:variable name="lower" select="srv:DCPList/@codeListValue"/>
				<dt>
					<em>
						<xsl:call-template name="get_property">
					...
					<xsl:choose>
						<xsl:when test="translate($lower,'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz') ='webservices'">
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdCode.operationDCP.WebServices</xsl:with-param>
							</xsl:call-template>
						</xsl:when>
						<xsl:otherwise>
							<xsl:call-template name="get_property">
								<xsl:with-param name="key">catalog.mdCode.operationDCP.<xsl:value-of select="srv:DCPList/@codeListValue"/>
								</xsl:with-param>
							</xsl:call-template>
						</xsl:otherwise>
					</xsl:choose>
	...
	<xsl:template match="gmd:RS_Identifier | gmi:identifier/gmd:MD_Identifier">
		<dt>
			<em>
				<xsl:call-template name="get_property">
					<xsl:with-param name="key">catalog.mdParam.rndt.identification.datasetIdentifierCS</xsl:with-param>
				</xsl:call-template>
				<xsl:text>:&#x20;</xsl:text>
			</em>
	...
	<xsl:template name="get_property">
		...
		<xsl:choose>
			...
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.dataQuality.conceptualConsistency.caption&quot; '>i18n.catalog.iso19139.DQ_ConceptualConsistency</xsl:when>
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.dataQuality.conceptualConsistency.nameOfMeasure&quot; '>i18n.catalog.iso19139.AbstractDQ_Element.nameOfMeasure</xsl:when>
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.dataQuality.conceptualConsistency.measureDescription&quot; '>i18n.catalog.iso19139.AbstractDQ_Element.measureDescription</xsl:when>
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.dataQuality.conceptualConsistency.value&quot; '>i18n.catalog.iso19139.AbstractDQ_Element.result</xsl:when>
			...
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.identification.serviceType.caption.metadataXML&quot; '>i18n.catalog.mdParam.rndt.identification.serviceType.caption.metadataXML</xsl:when>
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.identification.datasetIdentifierCS&quot; '>i18n.catalog.mdParam.rndt.identification.datasetIdentifierCS</xsl:when>
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.constraints.service.caption&quot; '>i18n.catalog.mdParam.rndt.constraints.service.caption</xsl:when>
