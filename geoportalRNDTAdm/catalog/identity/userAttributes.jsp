...
<%@ taglib prefix="h" uri="http://java.sun.com/jsf/html" %>
 ...
 <% // ESRI Italy: added website %>
  <h:outputLabel for="website"
    rendered="#{SelfCareController.hasUserAttribute['website']}"
    value="#{gptMsg['catalog.identity.profile.label.website']}"/>
  <h:inputText id="website" size="30" maxlength="256" 
    rendered="#{SelfCareController.hasUserAttribute['website']}"
    value="#{SelfCareController.activeUserAttributes['website'].value}"/>
  <% // separator %>
  <h:outputText value=""/><h:outputText escape="false" value="&nbsp;"/>
