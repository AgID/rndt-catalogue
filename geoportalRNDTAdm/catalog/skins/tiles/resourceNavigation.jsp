...
<%
	...
	String recordTitle = request.getParameter("title");
	...
	{	
		isExternal = true;
		extid = java.net.URLEncoder.encode(extid,"UTF-8");
		rnpRestUrl = rnpContextPath+"/rest/document?id=" + extid + "&rid="+rid+"&f=json";
		rnpQueryString = "uuid="+ extid+"&rid="+rid+"&title="+recordTitle;	
		makeUrls(rnpContextPath,rnpQueryString);
	}
%>
<%!
