...
private void executeSendFeedback(ActionEvent event, RequestContext context) 
  ...
  //mailReq.setFromAddress(sEmail);modified by esri Italy: mittente e ricevente settati allo stesso indirizzo
    mailReq.setFromAddress(mailReq.getToAddress());
    mailReq.setSubject(sSubject);
    mailReq.setBody(sBody);
    mailReq.send();
    
    //modified by esri italy: non fa reply
