...
public class SearchResultRecordAdapter implements IFeedRecord {
  ...
  /** Added by Esri Italy  ***/
  /**
   * Additional parameters to handle a richer JSON response
   */
   @Override
  public String getHierarchyLevel() {
    return record.getHierarchyLevel();
  }
  /** 09/01/2017  Update Administration Data **/
   @Override
  public String getResponsibleData() {
    return record.getResponsibleData();
  }
   @Override
  public String getPointOfContactName() {
    return record.getPointOfContactName();
  }
   @Override
  public String getPointOfContactEmail() {
    return record.getPointOfContactEmail();
  }
   @Override
  public String getPointOfContactTel() {
    return record.getPointOfContactTel();
  }
   /** 09/01/2017  Update Administration Data **/
    @Override
  public String[] getKeywords() {
    return record.getKeywords();
  }
