...
import static com.esri.gpt.framework.util.LogUtil.getLogger;
...
// Esri Italy Ott. 2017
// Modified for possiile injection problem on style parameter , ex: style=<script>malicious code</script>
    String appo = getRequestParameter(restKey);
    String appo2 = appo.replace(" +", "").toLowerCase();
    if (appo2.indexOf("script") > -1){
        appo = "";
        getLogger().warning ("possibile injection on style parameter: found script tag:" + appo);
    }
    getQuery().setResponseStyle(appo);
  }
