...
/*** Added by Esri Italy ****/
  ...
  private String        _responsibleData="";
  private String        _pointOfContactName="";
  private String        _pointOfContactEmail="";
  private String        _pointOfContactTel="";
  //private String[]      _keywords = new String[100]; // maximum of keywords
...
//    _defaultGeometry = false; 
 ...
 // Strip out xml/html characters
  ...
  /*** Added by Esri Italy **************/
    /**
   * Gets the modified HierarchyLevel.
   ...
   * @param HierarchyLevel the new HierarchyLevel
   */
  public void setHierarchyLevel(String HierarchyLevel) {
    _hierarchyLevel = Val.chkStr(HierarchyLevel);
  }
/** 09/01/2017  Update Administration Data **/
 /**
 * Gets the responsibleData.
 * 
...
/**
 * Sets the responsibleData.
 * 
 * @param responsibleData the new responsibleData
 */
public void setResponsibleData(String s_responsibleData) {
  this._responsibleData = s_responsibleData;
}
 /**
 * Gets the pointOfContactName.
 * 
 * @return the pointOfContactName 
 */
public String getPointOfContactName() {
  return _pointOfContactName;
}

/**
 * Sets the pointOfContactName.
 * 
 * @param pointOfContactName the new pointOfContactName
 */
public void setPointOfContactName(String s_pointOfContactName) {
  this._pointOfContactName = s_pointOfContactName;
}
 /**
 * Gets the pointOfContactEmail.
 * 
 * @return the pointOfContactEmail 
 */
public String getPointOfContactEmail() {
  return _pointOfContactEmail;
}

/**
 * Sets the pointOfContactEmail.
 * 
 * @param pointOfContactEmail the new pointOfContactEmail
 */
public void setPointOfContactEmail(String s_pointOfContactEmail) {
  this._pointOfContactEmail = s_pointOfContactEmail;
}
 /**
 * Gets the pointOfContactTel.
 * 
 * @return the pointOfContactTel 
 */
public String getPointOfContactTel() {
  return _pointOfContactTel;
}

/**
 * Sets the pointOfContactTel.
 * 
 * @param pointOfContactTel the new pointOfContactTel
 */
public void setPointOfContactTel(String s_pointOfContactTel) {
  this._pointOfContactTel = s_pointOfContactTel;
}
    ...
    /**
   * Gets the modified Keywords.
   * @return the keywords
   */
  public String[] getKeywords() {
    return _keywords.toArray(new String[_keywords.size()]);
  }
  /**
   * Sets the Keywords.
   * @param keywords the new Keywords (string array)
   */
  public void setKeywords(List<String> keywords) {
      _keywords=keywords;
//    for (int i=0; i<keywords.length; i++)
//    {
//      _keywords[i] = Val.chkStr(keywords[i]);
//    }
