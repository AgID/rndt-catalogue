...
Gestione per il riconoscimento se l'upload è fallito
*/
private boolean _wasDocumentAsDraftWithErrors = false;
/*ESRI 14/03/2017 sostituizione dettata dalle impostazioni utente*/
private boolean _wasDocumentNotReplaced = false;
/*ESRI 14/03/2017 sostituizione dettata dalle impostazioni utente*/
...
/**ESRI ITALIA 13/04/2017
 * Gets the status indicating if a document was in Draft 
 * (no XML change, no database update tool place).
 * @return true if the document was unchanged
 */
public boolean getWasDocumentAsDraftWithErrors() {
  return _wasDocumentAsDraftWithErrors;
}
/**
 * Sets the status indicating if a document was saved in Draft 
 * (no XML change, no database update tool place).
 * @param wasUnchanged true if the document was unchanged
 */
protected void setWasDocumentAsDraftWithErrors(boolean wasDraft) {
  _wasDocumentAsDraftWithErrors = wasDraft;
}
/**ESRI ITALIA 13/04/2017*/
/*ESRI 14/03/2017 sostituizione dettata dalle impostazioni utente*/
public boolean getWasDocumentNotReplaced() {
  return _wasDocumentNotReplaced;
}
/**
 * Sets the status indicating if a document was saved in Draft 
 * (no XML change, no database update tool place).
 * @param wasUnchanged true if the document was unchanged
 */
protected void setWasDocumentNotReplaced(boolean wasNotReplaced) {
  _wasDocumentNotReplaced = wasNotReplaced;
}
/*ESRI 14/03/2017 sostituizione dettata dalle impostazioni utente*/
