...
public  static final String ACTION_STATUS_NONE_EXIST  = "EXIST";
/*ESRI ITALIA 14/03/2017 gestione del flag per la sovrascrittura del metadato*/
// instance variables ==========================================================
...
protected void setActionStatus(String actionStatus) {
  ...
  } else if (actionStatus.equalsIgnoreCase(ACTION_STATUS_NONE_EXIST)) {
    _actionStatus = ACTION_STATUS_NONE_EXIST;
  } else {
