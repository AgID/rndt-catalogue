...
<!-- template for escaping text -->
	...
	<xsl:template name="get_property">
		...
		<xsl:choose>
			...
			<xsl:when test='$key = &quot;catalog.mdParam.rndt.dataQuality.topologicalConsistency.caption&quot; '>i18n.catalog.mdParam.rndt.dataQuality.topologicalConsistency.caption</xsl:when>
