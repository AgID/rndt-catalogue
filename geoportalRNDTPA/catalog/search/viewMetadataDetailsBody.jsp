...
<%
  ...
  String sRestUrl = "";
  if(vmdUuid!=null)
	sRestUrl=request.getContextPath()+"/rest/document?f=html&id="+java.net.URLEncoder.encode(vmdUuid,"UTF-8");
  else
	sRestUrl=request.getContextPath()+"/rest/document?f=html&id="+java.net.URLEncoder.encode(extid,"UTF-8")+"&rid="+java.net.URLEncoder.encode(rid,"UTF-8");
...
<script type="text/javascript">
  ...
  /********Added By ESRI Italy*******/
  /**Get the initial Extent parameter**/
...
<f:verbatim>
  <!--ESRI Italy-->
  <!--<iframe class="section" src="<%=sRestUrl+"&style="+request.getContextPath()+"/catalog/skins/themes/snippet.css"%>" width="100%" scrolling="no" frameborder="0"></iframe>-->
