...
<!--// Esri Italy October 2016: function to handle lnaguage choice -->	
	<nav  id="nav_it" name="nav_it" style="display:none; align:right">
    <ul>

        <li>
            <a href="javascript:createCookie('geoportalLocale', 'it');" ><img  id="img1" name="img1" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/it.png" alt="it"  title="Italiano" /> &nbsp;Italiano</a>
            <ul>
                <li><a href="javascript:createCookie('geoportalLocale', 'it');" ><img  id="img2" name="img2" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/it.png" alt="it"  title="Italiano" /> &nbsp;Italiano</a></li>
                <li><a href="javascript:createCookie('geoportalLocale', 'en');"><img  id="img3" name="img3" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/en.png" alt="en" title="English" />&nbsp;English&nbsp;&nbsp;</a></li>
            </ul>
        </li>
    ...
    <ul>
        ...
        <li>
            <a href="javascript:createCookie('geoportalLocale', 'en');"><img  id="img4" name="img4" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/en.png" alt="en" title="English" />&nbsp;English&nbsp;&nbsp;&nbsp;</a>
            <ul>
                <li><a href="javascript:createCookie('geoportalLocale', 'en');"><img  id="img5" name="img5" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/en.png" alt="en" title="English" />&nbsp;English&nbsp;&nbsp;&nbsp;</a></li>
                <li><a href="javascript:createCookie('geoportalLocale', 'it');" ><img  id="img6" name="img6" class="iclflag" src="<%=request.getContextPath()%>/catalog/images/it.png" alt="it"  title="Italiano" /> &nbsp;Italiano</a></li>
            </ul>
        </li>
...
<!--// END  Esri Italy October 2016: (function to handle lnaguage choice) -->	
</h:form>
