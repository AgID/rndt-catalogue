...
<f:subview id="svSecondaryNavigation">
   <f:subview id="svScript">
	...
	<h:form id="frmSecondaryNavigation"
	  ...
	  <h:commandLink action="catalog.publication.manage.collection.members"
	    id="publicationManageCollection"
	    rendered="#{PageContext.roleMap['gptAdministrator']}"
	    value="#{gptMsg['catalog.publication.manage.collections']}"
	    styleClass="#{PageContext.menuStyleMap['catalog.publication.manage.collections']}"/>
