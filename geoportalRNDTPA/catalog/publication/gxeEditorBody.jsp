...
<script type="text/javascript">
  ...
  gptMapConfig.mapToolName = "deactivate";
  var gxeLocale = "<%=request.getLocale().toString()%>";
  var currentID = "<%=com.esri.gpt.control.publication.supportForMetadata.getCurrentIdentifier(com.esri.gpt.framework.context.RequestContext.extract(request))%>";
</script>

<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/gpt/gxe/gxe.css"></link>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/catalog/skins/themes/rndt/gxeCustom.css"></link>
...
$("html").click(function(){
  ...
  if (typeof(dojo) != 'undefined') {
    ...
    function gxeUndo(){
		...
		document.location.href="<%=request.getContextPath()%>/catalog/publication/manageMetadata.page";
