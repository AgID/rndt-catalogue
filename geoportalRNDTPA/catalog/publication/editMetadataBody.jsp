...
function MdeMap() {
  ...
  this.initialize = function initialize() {
    ...
    config.mapToolName = "deactivate"; //Edit By Esri Italy: default=pan instead of drawInputEnvelope
...
<% // prompt %>
<%//Added by Esri Italy: show the schema key%>
<h:outputText escape="false" styleClass="successMessage"
  value="#{EditMetadataController.openSchemaKey}"/>
...
<h:panelGrid columns="4" summary="#{gptMsg['catalog.general.designOnly']}"
  styleClass="table" columnClasses="formLabelColumn,formInputColumn">
