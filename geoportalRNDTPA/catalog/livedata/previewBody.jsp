...
<div class="section previewMapSection">
  <iframe src="<%=makeSafeUrl(prvContextPath,Val.escapeXmlForBrowser(LiveDataController.getCurrentInstance().getEmbededUrl())+"&extent="+request.getParameter("extent"))%>"          
...
<!--Esri Italy: Added style -->
  <iframe src="<%=makeSafeUrl(prvContextPath,Val.escapeXmlForBrowser(LiveDataController.getCurrentInstance().getInfoUrl())+"&style="+request.getContextPath()+"/catalog/skins/themes/snippet.css")%>" 
