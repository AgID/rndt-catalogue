...
//ESRI Italy: imposta l'extent a quella del servizio
String extent = Val.chkStr(request.getParameter("extent")!=null? request.getParameter("extent"): imConfig.getMapInitialExtent());
%>
<%!
/**
 * Escapes string.
