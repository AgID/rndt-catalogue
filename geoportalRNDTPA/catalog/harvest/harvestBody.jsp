...
var disabilita = <%=(tipiElenco2.equals("pa"))%>;
...
dojo.addOnLoad(function() {
  ...
  /*ESRI ITALIA 23/03/2017 */
    var checked = dojo.byId("harvestCreate:protocolType").options[dojo.byId("harvestCreate:protocolType").selectedIndex].value;
    selectSection(checked);
    dojo.byId("harvestCreate:protocolType").onchange= function (v) {
    selectSection(v.target.options[v.target.selectedIndex].value);
  };
/*ESRI ITALIA 23/03/2017 */
      ...
      switch (getRadio()) {
        ...
        case "PATTERN":
          ...
          if (Number.isNaN(dayOfTheMonthInput)) {
            ...
            if (dayOfTheWeek.length>0) {
				//Modifiche EsriItalia
				//Sono valorizzati sia il giorno della settimana che il numero.
				//devo verificareil il numero sia compreso tra 1 e 5
				if ((dayOfTheMonthInput>=1) && (dayOfTheMonthInput<=5)){
					//OK
				  ...
				  timePoint.msg = RES.DayOfTheWeekInTheMonthEvent.replace("\{0\}",dayOfTheMonthInput).replace("\{1\}",dayOfTheWeek).replace("\{2\}",timeString);
					...
					//Non va bene
					alert("<fmt:message key='catalog.harvest.manage.test.msg.checkDate.alertWeek'/>");
				}	
            } else {
				//E' valorizzato solo il numero.
				//devo verificareil il numero sia compreso tra 1 e 31
				if ((dayOfTheMonthInput>=1) && (dayOfTheMonthInput<=31)){
					//OK
				  ...
				  timePoint.msg = RES.DayOfTheMonthEvent.replace("\{0\}",dayOfTheMonthInput).replace("\{1\}",timeString);
					...
					//Non va bene
					alert("<fmt:message key='catalog.harvest.manage.test.msg.checkDate.alertNoweek'/>");
				}
            }
          }
          break;
...
<h1 class="title_custom"><%=com.esri.gpt.framework.jsf.PageContext.extractMessageBroker(
                                                                          ).retrieveMessage("catalog.esriItaliaAdd.harvest.title")%></h1>
...
<h:panelGrid columns="2" summary="#{gptMsg['catalog.general.designOnly']}"
  styleClass="table">
    ...
    <%-- Repository uuid ESRI ITALIA Nascosco UUID
...
<h:panelGrid id="repositoryHeader" columns="2" summary="#{gptMsg['catalog.general.designOnly']}"
             styleClass="table_padding" columnClasses="formInputColumn">

<%-- Protocol Type --%>
<h:outputText value="#{gptMsg['catalog.harvest.manage.edit.protocolType']}"/>

<h:selectOneMenu value="#{HarvestController.editor.type}" id="protocolType" > <!--layout="pageDirection">-->
...
<h:panelGrid id="repositoryMain" columns="1" styleClass="table_padding" summary="#{gptMsg['catalog.general.designOnly']}">
...
<h:panelGroup styleClass="hostUrlClass">
  <h:inputText size="50" value="#{HarvestController.editor.hostUrl}" styleClass="form-control" id="hostUrl"/>
...
<h:inputText   styleClass="form-control arcgis" size="50" value="#{HarvestController.editor.soapUrl}" id="soapUrl"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
    <div class="hint arcgis" style="display: none;">
...
<h:inputText size="50" value="#{HarvestController.editor.name}" styleClass="form-control" id="name"/>
...
<h:inputText   styleClass="form-control arcims" size="30" value="#{HarvestController.editor.attrs['service']}" id="serviceName"/>

<%-- username name --%>
<h:outputLabel styleClass="arcims" for="arcImsUserName" value="#{gptMsg['catalog.harvest.manage.edit.userName']}"/>
<h:inputText   styleClass="form-control arcims" size="30" value="#{HarvestController.editor.attrs['arcims.username']}" id="arcImsUserName"/>

<%-- username password --%>
<h:outputLabel styleClass="arcims" for="arcImsUserPassword" value="#{gptMsg['catalog.harvest.manage.edit.userPassword']}"/>
<h:inputSecret styleClass="form-control arcims" redisplay="true" size="30" value="#{HarvestController.editor.attrs['arcims.password']}" id="arcImsUserPassword"/>
...
<h:inputText   styleClass="form-control oai" size="30" value="#{HarvestController.editor.attrs['prefix']}" id="prefix"/>

<%-- Set --%>
<h:outputLabel styleClass="oai" for="set" value="#{gptMsg['catalog.harvest.manage.edit.set']}"/>
<h:inputText   styleClass="form-control oai" size="30" value="#{HarvestController.editor.attrs['set']}" id="set"/>
...
<h:inputSecret styleClass="form-control waf" redisplay="true" size="30" value="#{HarvestController.editor.attrs['waf.password']}" id="wafImsUserPassword"/>
...
<h:selectOneMenu styleClass="form-control atom" value="#{HarvestController.editor.attrs['atomInfoProcessorClassName']}" id="atomType">
...
<h:inputText   styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['src-h']}" id="src-h"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
...
<h:inputText   styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['src-u']}" id="src-u"/>

<%-- src password --%>
<h:outputLabel styleClass="requiredField agp2agp" for="src-p" value="#{gptMsg['catalog.harvest.manage.edit.src.p']}"/>
<h:inputSecret redisplay="true" styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['src-p']}" id="src-p"/>

<%-- src query --%>
<h:outputLabel styleClass="requiredField agp2agp" for="src-q" value="#{gptMsg['catalog.harvest.manage.edit.src.q']}"/>
<h:panelGroup>
<h:inputText   styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['src-q']}" id="src-q"/>
<h:commandButton 
  id="testQuery"
...
<h:inputText   styleClass="form-control agp2agp" size="10" value="#{HarvestController.editor.attrs['src-m']}" id="src-m"/>
...
<h:inputText   styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['dest-h']}" id="dest-h"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
    <div class="hint agp2agp" style="display: none;">
...
<h:inputText   styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['dest-u']}" id="dest-u"/>

<%-- dest password --%>
<h:outputLabel styleClass="requiredField agp2agp" for="dest-p" value="#{gptMsg['catalog.harvest.manage.edit.dest.p']}"/>
<h:panelGroup>
<h:inputSecret redisplay="true" styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['dest-p']}" id="dest-p"/>
<h:commandButton 
  id="testClient"
...
<h:panelGroup>
<h:inputText styleClass="form-control agp2agp" size="30" value="#{HarvestController.editor.attrs['dest-o']}" id="dest-o"/>
<f:verbatim>
...
<h:panelGroup>
<h:inputText   styleClass="form-control agp2agp" size="40" value="#{HarvestController.editor.attrs['dest-f']}" id="dest-f"/>
<f:verbatim>
...
<h:panelGroup>
<h:inputText   styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-src-restUrl']}" id="ags-src-restUrl"/>
<h:outputText value="&nbsp;" escape="false"/>
<h:commandButton 
...
<h:inputText   styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-src-soapUrl']}" id="ags-src-soapUrl"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
    <div class="hint ags2agp" style="display: none;">
...
<h:inputText   styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-dest-h']}" id="ags-dest-h"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
    <div class="hint ags2agp" style="display: none;">
...
<h:inputText   styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-dest-u']}" id="ags-dest-u"/>

<%-- dest password --%>
<h:outputLabel styleClass="requiredField ags2agp" for="ags-dest-p" value="#{gptMsg['catalog.harvest.manage.edit.dest.p']}"/>
<h:panelGroup>
<h:inputSecret redisplay="true" styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-dest-p']}" id="ags-dest-p"/>
<h:commandButton 
...
<h:panelGroup>
<h:inputText styleClass="form-control ags2agp" size="30" value="#{HarvestController.editor.attrs['ags-dest-o']}" id="ags-dest-o"/>
<f:verbatim>
...
<h:panelGroup>
<h:inputText   styleClass="form-control ags2agp" size="40" value="#{HarvestController.editor.attrs['ags-dest-f']}" id="ags-dest-f"/>
<f:verbatim>
...
<h:inputText   styleClass="form-control gpt2agp" size="30" value="#{HarvestController.editor.attrs['gpt-dest-h']}" id="gpt-dest-h"/>
<h:panelGroup></h:panelGroup>
<h:panelGroup>
  <verbatim>
...
<h:inputText   styleClass="form-control gpt2agp" size="30" value="#{HarvestController.editor.attrs['gpt-dest-u']}" id="gpt-dest-u"/>

<%-- dest password --%>
<h:outputLabel styleClass="requiredField gpt2agp" for="gpt-dest-p" value="#{gptMsg['catalog.harvest.manage.edit.dest.p']}"/>
<h:panelGroup>
<h:inputSecret redisplay="true" styleClass="form-control gpt2agp" size="30" value="#{HarvestController.editor.attrs['gpt-dest-p']}" id="gpt-dest-p"/>
<h:commandButton 
...
<h:panelGroup>
<h:inputText styleClass="form-control gpt2agp" size="30" value="#{HarvestController.editor.attrs['gpt-dest-o']}" id="gpt-dest-o"/>
<f:verbatim>
...
<h:panelGroup>
<h:inputText   styleClass="form-control gpt2agp" size="40" value="#{HarvestController.editor.attrs['gpt-dest-f']}" id="gpt-dest-f"/>
<f:verbatim>
...
<h:inputText styleClass="form-control dcat" size="30" value="#{HarvestController.editor.attrs['dcatFormat']}" id="dcat-format"/>
...
<div id="divForScope" name="divForScope">
    
<h:panelGrid columns="2" summary="#{gptMsg['catalog.general.designOnly']}"
  styleClass="onBehalfOf" columnClasses="formLabelColumn,formInputColumn">
...
<h:panelGrid  columns="2" summary="#{gptMsg['catalog.general.designOnly']}"  styleClass="table" columnClasses="formInputColumn," rendered="#{HarvestController.robotsTxtOverride}">
      ...
      <div>
        ...
        <div>
          ...
          <select id="dayOfTheWeekInput" data-dojo-type="dijit.form.Select">
              ...
              <option value="DOMENICA"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.SUNDAY"/></option>
              <option value="LUNEDI"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.MONDAY"/></option>
              <option value="MARTEDI"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.TUEASDAY"/></option>
              <option value="MERCOLEDI"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.WEDNESDAY"/></option>
              <option value="GIOVEDI"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.THURSDAY"/></option>
              <option value="VENERDI"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.FRIDAY"/></option>
              <option value="SABATO"><fmt:message key="catalog.com.esri.gpt.framework.adhoc.events.SATURDAY"/></option>
          </select>    
        </div>
      </div>
    </div>
